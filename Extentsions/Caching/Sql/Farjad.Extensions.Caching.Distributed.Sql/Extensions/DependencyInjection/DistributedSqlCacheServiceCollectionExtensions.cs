...
using Farjad.Extensions.Caching.Distributed.Sql.Options;
using Farjad.Extensions.Caching.Distributed.Sql.Services;

namespace Farjad.Extensions.Caching.Distributed.Sql.Extensions.DependencyInjection
{

    public static class DistributedSqlCacheServiceCollectionExtensions
    {
        public static IServiceCollection AddFarjadSqlDistributedCache(this IServiceCollection services,
                                                                      IConfiguration configuration,
                                                                      string sectionName)
            => services.AddFarjadSqlDistributedCache(configuration.GetSection(sectionName));

        public static IServiceCollection AddFarjadSqlDistributedCache(this IServiceCollection services, IConfiguration configuration)
        {
