    ...
    where TCommand : ICommand<TData>
{
    ...
    public CommandHandler(FarjadServices FarjadServices)
    {
    ...
    {
        result.AddMessage(_FarjadServices.Translator[message]);
    }

    protected void AddMessage(string message, params string[] arguments)
    {
        result.AddMessage(_FarjadServices.Translator[message, arguments]);
    }
}
