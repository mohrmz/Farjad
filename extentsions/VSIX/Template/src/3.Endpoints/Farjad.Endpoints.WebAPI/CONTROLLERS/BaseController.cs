...
using Farjad.Endpoints.WebApi.Extentions;
using Farjad.Extensions.Serializers.Abstractions;
using Farjad.Utilities;
using System.Net;

namespace Farjad.Endpoints.WebApi.Controllers;
...
public class BaseController : Controller
{
    ...
    protected FarjadServices FarjadApplicationContext => HttpContext.FarjadApplicationContext();
